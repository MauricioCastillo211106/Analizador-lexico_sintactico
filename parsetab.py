...
_lr_productions = [
  ...
  ('VL -> AS N','VL',2,'p_VL','analizador.py',82),
  ('VL -> AS CM ID CM','VL',4,'p_VL','analizador.py',83),
  ('VL -> <empty>','VL',0,'p_VL','analizador.py',84),
  ('F -> VQ ID PA P PC LA C LC','F',8,'p_F','analizador.py',87),
  ('P -> TP ID','P',2,'p_P','analizador.py',90),
  ('CL -> PQ PA V PT ID OP ON PT ID IN PT PC LA C LC','CL',15,'p_CL','analizador.py',93),
  ('IF -> VS PA CD PC LA C LC NS LA C LC','IF',11,'p_IF','analizador.py',96),
  ('CD -> ID OP ON','CD',3,'p_CD','analizador.py',99),
  ('ON -> ID','ON',1,'p_ON','analizador.py',102),
  ('ON -> N','ON',1,'p_ON','analizador.py',103),
  ('M -> VQ SO PA PC LA C LC','M',7,'p_SO','analizador.py',106),
]
